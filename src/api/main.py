...
def get_api_base_url() -> str:
    ...
    """
    # For Render deployment - use 0.0.0.0 to reach other processes on the same server
...
if st.session_state.started:
    ...
    if prompt:
        ...
        # Check if user is confirming a deal
        ...
        with st.spinner("🤔 Analyzing..."):
            try:
                ...
                if response.status_code == 200:
                    ...
                    # Check if assistant message contains deal confirmation
